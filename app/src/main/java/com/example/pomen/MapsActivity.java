...
import com.example.pomen.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workshop = findViewById(R.id.button);
        utube = (ImageButton) findViewById(R.id.buttonutube);
